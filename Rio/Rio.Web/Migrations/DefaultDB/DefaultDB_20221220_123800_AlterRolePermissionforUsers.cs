...
{
    [Migration(20221220123800)]
    public class DefaultDB_20221220_123800_AlterRolePermissionforUsers : Migration
    {
        public override void Up()
        {
            ...
            Insert.IntoTable("Roles")
                ...
                {
                    RoleName = "Manager",
                    RoleKey = "Administration:Managers"
                });
            ...
            Insert.IntoTable("Roles")
                ...
                {
                    RoleName = "Student",
                    RoleKey = "Administration:Students"
                });
            #endregion
