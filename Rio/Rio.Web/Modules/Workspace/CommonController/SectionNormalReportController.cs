...
{
    public class SectionNormalReportController : Controller
    {
        ...
        [Route("~/SectionReport/NormalReport")]
        public IActionResult getNormalSectionReport(string ScannedSheetId, [FromServices] ISqlConnections sqlConnections,[FromServices] IExamSectionResultListHandler handler,[FromServices] IExamResultRetrieveHandler retrievehandler)
        {
            ...
            using (var Connection = sqlConnections.NewByKey("Default"))
            {
                ...
                return View(MVC.Views.ExamResult.ExamSectionResultNormalReport, report);
            }
        }
    }
}
