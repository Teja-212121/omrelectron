...
namespace Rio.Web.Modules.Workspace.CommonController
{
    [Report("Workspace.ExamQuestionResult")]
    [ReportDesign("ExamQuestionResultPivot")]
    [RequiredPermission(PermissionKeys.General)]
    public class ExamQuestionResultPivotController : Controller, ICustomizeHtmlToPdf
    {
        ...
        [Route("~/ExamQuestionResult/ExamQuestionResultPivot")]
            ...
            [FromServices] IScannedQuestionRetrieveHandler scanquestionhandler)
        {
            using (var connection = SqlConnections.NewByKey("Default"))
            {
                ...
                return View(MVC.Views.ExamQuestionResult.ExamQuestionResultPivot,model as ExamResultReportModel);
            }
        }
