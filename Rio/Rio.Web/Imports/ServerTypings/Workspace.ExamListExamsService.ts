namespace Rio.Workspace {
    export namespace ExamListExamsService {
        ...
        export declare function AssignExamList(request: Serenity.SaveRequest<ExamListExamsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export declare const enum Methods {
            ...
            AssignExamList = "Workspace/ExamListExams/AssignExamList"
        }
