...
declare namespace Serenity.UI {
    ...
    class Categories extends React.Component<CategoriesProps> {
        ...
        renderCategory(group: Q.Group<PropertyItem>): React.ReactNode;
        render(): JSX.Element;
    }
}
declare namespace Serenity.UI {
    ...
    class Category extends React.Component<CategoryProps, Partial<CategoryProps>> {
        ...
        renderField(item: PropertyItem): React.ReactNode;
        renderWithBreak(item: PropertyItem): React.ReactNode[];
        render(): JSX.Element;
    }
}
declare namespace Serenity.UI {
...
declare namespace Serenity.UI {
    ...
    class PropertyTabs extends React.Component<PropertyTabProps> {
        ...
        renderCategories(group: Q.Group<PropertyItem>): React.ReactNode;
        render(): JSX.Element;
    }
}
declare namespace Serenity.UI {
