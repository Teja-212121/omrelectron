...
declare namespace Serenity {
    interface GridEditOptions<TItem = any> {
        ...
        validator?: (value: any, args: Slick.EditorOptions) => string;
    }
    class GridEditController<TItem = any> implements Slick.EditorFactory {
        private _options;
        private dirtyStyles;
        constructor(opt: GridEditOptions<TItem>);
        updateModifiedClassesForRow(row: number): void;
        get options(): GridEditOptions<TItem>;
        getEditor(column: Slick.Column<any>, row: number): Slick.EditorClass;
        isDirty(): boolean;
        ...
        undoChanges(): void;
        saveChanges(): void;
        static saveChangesButton(controller: () => GridEditController): Serenity.ToolButton;
        static undoButton(controller: () => GridEditController): Serenity.ToolButton;
    }
}
declare namespace Slick {
    interface Column<TItem = any> {
        editable?: boolean;
        editableProperty?: Serenity.PropertyItem;
        editorParams?: any;
    }
}
declare namespace Serenity {
    class GridEditWrapper implements Slick.Editor {
        private args;
        private editor;
        private defaultValue;
        constructor(args: Slick.EditorOptions);
        focus(): void;
        ...
        position?(pos: Slick.Position): void;
        preClick?(): void;
        hide?(): void;
        show?(): void;
        validate?(): Slick.ValidationResult;
        destroy(): void;
    }
}
declare namespace Serenity {
    ...
    class AutoColumnWidthMixin extends Serenity.Widget<AutoColumnWidthMixinOptions> {
        ...
        getPreSetWidth(columnDef: Slick.Column): number;
    }
}
declare namespace Serenity {
...
declare namespace Slick.Plugins {
    ...
    class HeaderFilters {
        ...
        private filterTexts;
        onFilterApplied: Event<any, IEventData>;
        onCommand: Event<any, IEventData>;
